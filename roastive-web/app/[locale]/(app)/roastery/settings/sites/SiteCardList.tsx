            ...
            <div className="shrink-0 flex items-center gap-2">
              {onEdit && (
                <button
                  ...
                  className="rounded-md bg-gray-100 px-2.5 py-1.5 text-xs font-medium text-gray-700 ring-1 ring-inset ring-gray-300 hover:bg-gray-200 dark:bg-white/10 dark:text-white dark:ring-white/10 dark:hover:bg-white/20"
                >
                  수정
                </button>
              )}
